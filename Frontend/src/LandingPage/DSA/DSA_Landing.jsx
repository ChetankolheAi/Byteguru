     ...
     <div className="continer-dsa">
      ...
      <div className="Algorithm">
          ...
          <div className="inner_Algorithm">
            ...
            <Link to='/TreeHeightVisualizer'><button>Diameter of Tree</button></Link>
            <Link to='/BalancedTree'><button>Check if Tree is Balanced</button></Link>
            <Link to='/BSTsearch'><button>BST Search</button></Link>
            <Link to='/LCAVisualizer'><button>Lowest Common Ancestor</button></Link>
            <Link to='/LevelOrderTraversalVisualizer'><button>Level Order Traversal (BFS)</button></Link>
            
            
            <hr />
            <h3>Graph Algorithms</h3>
            <Link to='/UnderDevelopment'><button>DFS</button></Link>
            <Link to='/UnderDevelopment'><button>BFS</button></Link>
            <Link to='/UnderDevelopment'><button>Dijkstra</button></Link>
            <Link to='/UnderDevelopment'><button>Bellman-Ford</button></Link>
            <Link to='/UnderDevelopment'><button>Floyd-Warshall</button></Link>
            <Link to='/UnderDevelopment'><button>Prim's MST</button></Link>
            <Link to='/UnderDevelopment'><button>Kruskal's MST</button></Link>
