...
>   
  ...
  <div className="nav-item"><Link to="/"><i className="fa-regular fa-address-card"></i> AboutUs</Link></div>
  <div className="nav-item"><Link to="/"><i className="fa-solid fa-right-to-bracket"></i> Login</Link></div>
</div>
      <div
...
>   
  ...
  <div className="nav-item"><Link to="/"><i className="fa-solid fa-comments"></i> ChatBot</Link></div>
  <div className="nav-item"><Link to="/"><i className="fa-solid fa-clock-rotate-left"></i> History</Link></div>
  <div className="nav-item"><Link to="/"><i className="fa-solid fa-highlighter"></i> Styling</Link></div>
  <div className="nav-item"><Link to="/"><i className="fa-regular fa-address-card"></i> AboutUs</Link></div>
  <div className="nav-item"><Link to="/"><i className="fa-solid fa-right-to-bracket"></i> Login</Link></div>
</div>
