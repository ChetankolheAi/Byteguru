...
function SideBar({ isOpen}) {
    ...
    console.log(emailuser,isAuthenticated);
...
>   
    ...
    <div className="con1">
      ...
      {isAuthenticated
        ?
        <div className="nav-item" onClick={handleLogout}><Link to="/Login"><i className="fa-solid fa-right-to-bracket"></i> Logout</Link></div>
        :
